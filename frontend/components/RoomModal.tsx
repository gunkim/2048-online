      ...
      >
        <Form {...layout}>
          ...
          <Form.Item label="게임 모드">
            <Radio.Group name="mode" value={form.mode} onChange={handleChange}>
              ...
              <Radio value="SPEED_ATTACK" disabled>
                스피드
              </Radio>
              <Radio value="SURVIVAL" disabled>
                서바이벌
              </Radio>
            </Radio.Group>
          </Form.Item>
        ...
        <div>
          ...
          {form.mode == "SPEED_ATTACK" && (
            <p>
              빠르게 가장 먼저{" "}
              <span style={{ color: "blue", fontWeight: "bold" }}>2048</span>을
              만든 사람이 승리하는 모드입니다.
            </p>
          )}
          {form.mode == "SURVIVAL" && (
            <p>
              <span style={{ color: "blue", fontWeight: "bold" }}>마지막</span>
